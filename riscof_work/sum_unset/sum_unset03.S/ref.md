...
| COV_LABELS                | sum_unset03      |
| TEST_NAME                 | /home/ammar/Documents/my-github/riscv-ctg/riscof_work/sum_unset/sum_unset03.S/ref.S    |
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      ...
      [0x800000000006c8]:addi a1, zero, 201
      ...
      [0x800000000009cc]:addi t0, t0, 1024
      [0x800000000009d0]:slli t0, t0, 11
      [0x800000000009d4]:addi t0, t0, 1
      ...
      [0x80000000000a7c]:addi t0, t0, 1024
      [0x80000000000a80]:slli t0, t0, 11
      [0x80000000000a84]:addi t0, t0, 1
      ...
      [0x80000000000ad4]:addi s7, zero, 1
      [0x80000000000ad8]:slli s7, s7, 18
      [0x80000000000adc]:csrrc zero, mstatus, s7
      [0x80000000000ae0]:addi s1, zero, 4095
      [0x80000000000ae4]:srli s1, s1, 62
      [0x80000000000ae8]:slli s1, s1, 11
      [0x80000000000aec]:csrrc zero, mstatus, s1
      [0x80000000000af0]:addi s1, zero, 1
      [0x80000000000af4]:slli s1, s1, 11
      [0x80000000000af8]:csrrs zero, mstatus, s1
      [0x80000000000afc]:csrrs sp, mscratch, zero
      [0x80000000000b00]:ld t1, 1136(sp)
      [0x80000000000b04]:ld s1, 472(sp)
      [0x80000000000b08]:sub t1, t1, s1
      [0x80000000000b0c]:addi t1, t1, 16
      [0x80000000000b10]:auipc s1, 0
      [0x80000000000b14]:add s1, s1, t1
      [0x80000000000b18]:csrrw s1, mepc, s1
      [0x80000000000b1c]:mret
      [0x900000b20]:lui a4, 0
      [0x900000b24]:addi a4, a4, 0
      [0x900000b28]:slli a4, a4, 11
      [0x900000b2c]:addi a4, a4, 0
      [0x900000b30]:slli a4, a4, 11
      [0x900000b34]:addi a4, a4, 55
      [0x900000b38]:slli a4, a4, 10
      [0x900000b3c]:addi a4, a4, 685
      [0x900000b40]:sd a4, 16(s11)
      [0x900000b44]:addi zero, zero, 0
      [0x900000b48]:lui t0, 0
      [0x900000b4c]:addi t0, t0, 9
      [0x900000b50]:slli t0, t0, 11
      [0x900000b54]:addi t0, t0, 1024
      [0x900000b58]:slli t0, t0, 11
      [0x900000b5c]:addi t0, t0, 1
      [0x900000b60]:slli t0, t0, 10
      [0x900000b64]:addi t0, t0, 648
      [0x900000b68]:ld sp, 0(t0)
 ...
 -- Signature Addresses:
      Address: 0x80000000007228 Data: 0x0000000000000524
 -- Redundant Coverpoints hit by the op
      - mnemonic : csrrs
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      [0x80000000000fa8]:sd fp, 16(t1)
 -- Signature Addresses:
      Address: 0x80000000007248 Data: 0x000000000000052C
 -- Redundant Coverpoints hit by the op
      - mnemonic : sd

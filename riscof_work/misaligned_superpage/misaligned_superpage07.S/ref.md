...
| COV_LABELS                | misaligned_superpage07      |
| TEST_NAME                 | /home/ammar/Documents/my-github/riscv-ctg/riscof_work/misaligned_superpage/misaligned_superpage07.S/ref.S    |
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      ...
      [0x80000000000760]:addi a1, zero, 217
      ...
      [0x800000000007c0]:auipc a0, 0
      [0x800000000007c4]:addi a0, a0, 3780
      ...
      [0x800000000007e0]:addi a1, zero, 215
      ...
      [0x80000000000820]:addi t0, zero, 64
      ...
      [0x80000000000910]:addi t0, t0, 9
      [0x80000000000914]:slli t0, t0, 11
      [0x80000000000918]:addi t0, t0, 16
      ...
      [0x800000000009e0]:sd t2, 1800(sp)
      [0x800000000009e4]:lui t0, 0
      [0x800000000009e8]:addi t0, t0, 9
      [0x800000000009ec]:slli t0, t0, 11
      [0x800000000009f0]:addi t0, t0, 8
      [0x800000000009f4]:slli t0, t0, 11
      [0x800000000009f8]:addi t0, t0, 0
      [0x800000000009fc]:slli t0, t0, 10
      ...
      [0x80000000000ac4]:addi t1, t1, 3012
 ...
 -- Signature Addresses:
      Address: 0x80000000008228 Data: 0x00000000000004E8
 -- Redundant Coverpoints hit by the op
      - mnemonic : csrrs
...
Op without unique coverpoint updates Signature
 ...
 -- Signature Addresses:
      Address: 0x80000000008230 Data: 0x00000000000004E8
 -- Redundant Coverpoints hit by the op
      - mnemonic : sd
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      ...
      [0x80000000001514]:bltu t1, s1, 7044
      ...
      [0x80000000001578]:beq fp, zero, 7092
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      [0x80000000001468]:sd fp, 16(t1)
 -- Signature Addresses:
      Address: 0x80000000008248 Data: 0x00000000000004F0
 -- Redundant Coverpoints hit by the op
      - mnemonic : sd
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      [0x80000000001500]:sd fp, 24(t1)
 -- Signature Addresses:
      Address: 0x80000000008250 Data: 0x00000000000004F0
 -- Redundant Coverpoints hit by the op
      - mnemonic : sd
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      [0x80000000001468]:sd fp, 16(t1)
 -- Signature Addresses:
      Address: 0x80000000008268 Data: 0x00000000000004F8
 -- Redundant Coverpoints hit by the op
      - mnemonic : sd
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      [0x80000000001500]:sd fp, 24(t1)
 -- Signature Addresses:
      Address: 0x80000000008270 Data: 0x00000000000004F8
 -- Redundant Coverpoints hit by the op
      - mnemonic : sd
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      [0x80000000001468]:sd fp, 16(t1)
 -- Signature Addresses:
      Address: 0x80000000008288 Data: 0x0000000000000500
 -- Redundant Coverpoints hit by the op
      - mnemonic : sd
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      [0x80000000001500]:sd fp, 24(t1)
 -- Signature Addresses:
      Address: 0x80000000008290 Data: 0x0000000000000500
 -- Redundant Coverpoints hit by the op
      - mnemonic : sd
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      [0x80000000001468]:sd fp, 16(t1)
 -- Signature Addresses:
      Address: 0x800000000082a8 Data: 0x0000000000000508
 -- Redundant Coverpoints hit by the op
      - mnemonic : sd
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      [0x80000000001500]:sd fp, 24(t1)
 -- Signature Addresses:
      Address: 0x800000000082b0 Data: 0x0000000000000508
 -- Redundant Coverpoints hit by the op
      - mnemonic : sd
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      [0x80000000001468]:sd fp, 16(t1)
 -- Signature Addresses:
      Address: 0x800000000082c8 Data: 0x0000000000000510
 -- Redundant Coverpoints hit by the op
      - mnemonic : sd
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      [0x80000000001500]:sd fp, 24(t1)
 -- Signature Addresses:
      Address: 0x800000000082d0 Data: 0x0000000000000510
 -- Redundant Coverpoints hit by the op
      - mnemonic : sd
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      [0x80000000001468]:sd fp, 16(t1)
 -- Signature Addresses:
      Address: 0x800000000082e8 Data: 0x0000000000000518
 -- Redundant Coverpoints hit by the op
      - mnemonic : sd
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      [0x80000000001500]:sd fp, 24(t1)
 -- Signature Addresses:
      Address: 0x800000000082f0 Data: 0x0000000000000518
 -- Redundant Coverpoints hit by the op
      - mnemonic : sd
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      [0x80000000001468]:sd fp, 16(t1)
 -- Signature Addresses:
      Address: 0x80000000008308 Data: 0x0000000000000520
 -- Redundant Coverpoints hit by the op
      - mnemonic : sd
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      [0x80000000001500]:sd fp, 24(t1)
 -- Signature Addresses:
      Address: 0x80000000008310 Data: 0x0000000000000520
 -- Redundant Coverpoints hit by the op
      - mnemonic : sd
...
[0x80000000001510]:add t1, t1, t2
[0x80000000001514]:bltu t1, s1, 7044
[0x80000000001098]:csrrs t1, mscratch, zero
[0x8000000000109c]:addi t1, t1, 664
[0x800000000010a0]:ld t2, 568(t1)
[0x800000000010a4]:ld t2, 544(t1)
[0x800000000010a8]:csrrw zero, satp, t2
...
[0x800000000010a4]:ld t2, 544(t1)
[0x800000000010a8]:csrrw zero, satp, t2
[0x800000000010ac]:ld a0, 592(t1)
[0x800000000010b0]:csrrw zero, sscratch, a0
[0x800000000010b4]:ld s1, 584(t1)
[0x800000000010b8]:csrrw t2, stvec, s1
[0x800000000010bc]:andi s1, s1, 4092
[0x800000000010c0]:andi t2, t2, 4092
[0x800000000010c4]:bne s1, t2, 32
[0x800000000010e4]:csrrs t1, mscratch, zero
[0x800000000010e8]:ld t2, 568(t1)
[0x800000000010ec]:csrrw zero, medeleg, t2
[0x800000000010f0]:ld a0, 592(t1)
[0x800000000010f4]:csrrw zero, mscratch, a0
[0x800000000010f8]:ld s1, 584(t1)
[0x800000000010fc]:csrrw t2, mtvec, s1
[0x80000000001100]:andi s1, s1, 4092
[0x80000000001104]:andi t2, t2, 4092
[0x80000000001108]:bne s1, t2, 32
[0x80000000001128]:jal zero, 4436

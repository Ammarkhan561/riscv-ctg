...
| COV_LABELS                | misaligned_superpage02      |
| TEST_NAME                 | /home/ammar/Documents/my-github/riscv-ctg/riscof_work/misaligned_superpage/misaligned_superpage02.S/ref.S    |
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      ...
      [0x800000000006b8]:addi a1, zero, 201
      ...
      [0x800000000009c0]:addi t0, zero, 19
      [0x800000000009c4]:slli t0, t0, 31
      ...
      [0x80000000000a70]:addi t0, zero, 19
      [0x80000000000a74]:slli t0, t0, 31
      ...
      [0x80000000000ab0]:sfence.vma zero, zero
      [0x80000000000ab4]:addi s1, zero, 4095
      [0x80000000000ab8]:srli s1, s1, 62
      [0x80000000000abc]:slli s1, s1, 11
      [0x80000000000ac0]:csrrc zero, mstatus, s1
      [0x80000000000ac4]:addi s1, zero, 1
      [0x80000000000ac8]:slli s1, s1, 11
      [0x80000000000acc]:csrrs zero, mstatus, s1
      [0x80000000000ad0]:csrrs sp, mscratch, zero
      [0x80000000000ad4]:ld t1, 1136(sp)
      [0x80000000000ad8]:ld s1, 472(sp)
      [0x80000000000adc]:sub t1, t1, s1
      [0x80000000000ae0]:addi t1, t1, 16
      [0x80000000000ae4]:auipc s1, 0
      [0x80000000000ae8]:add s1, s1, t1
      [0x80000000000aec]:csrrw s1, mepc, s1
      [0x80000000000af0]:mret
      [0x900000af4]:lui a4, 0
      [0x900000af8]:addi a4, a4, 0
      [0x900000afc]:slli a4, a4, 11
      [0x900000b00]:addi a4, a4, 0
      [0x900000b04]:slli a4, a4, 11
      [0x900000b08]:addi a4, a4, 55
      [0x900000b0c]:slli a4, a4, 10
      [0x900000b10]:addi a4, a4, 685
      [0x900000b14]:sd a4, 16(s11)
      [0x900000b18]:addi zero, zero, 0
      [0x900000b1c]:addi t0, zero, 19
      [0x900000b20]:slli t0, t0, 31
      [0x900000b24]:ld sp, 0(t0)
 ...
 -- Signature Addresses:
      Address: 0x80000000008228 Data: 0x00000000000004E0
 -- Redundant Coverpoints hit by the op
      - mnemonic : csrrs
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      [0x800000000013e8]:sd fp, 16(t1)
 -- Signature Addresses:
      Address: 0x80000000008248 Data: 0x00000000000004E8
 -- Redundant Coverpoints hit by the op
      - mnemonic : sd
...
[0x800000000014b8]:ld sp, 656(sp)
[0x800000000014bc]:mret
[0x900000b34]:lui a4, 0
[0x900000b38]:addi a4, a4, 0
[0x900000b3c]:slli a4, a4, 11
[0x900000b40]:addi a4, a4, 0
[0x900000b44]:slli a4, a4, 11
[0x900000b48]:addi a4, a4, 47
[0x900000b4c]:slli a4, a4, 10
[0x900000b50]:addi a4, a4, 751
[0x900000b54]:sd a4, 24(s11)
[0x900000b58]:addi zero, zero, 0
[0x900000b5c]:addi sp, zero, 0
[0x900000b60]:ecall
[0x80000000001100]:jal zero, 256
[0x80000000001200]:csrrw sp, mscratch, sp
[0x80000000001204]:sd a1, 648(sp)
...
[0x80000000000b64]:addi a3, a3, 8
[0x80000000000b68]:addi a4, zero, 291
[0x80000000000b6c]:sd a4, 32(a3)
[0x80000000000b70]:jal zero, 1172

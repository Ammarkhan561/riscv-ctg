...
| COV_LABELS                | mxr_unset06      |
| TEST_NAME                 | /home/ammar/Documents/my-github/riscv-ctg/riscof_work/mxr_unset/mxr_unset06.S/ref.S    |
| Total Number of coverpoints| 9     |
| Total Coverpoints Hit     | 9      |
| Total Signature Updates   | 7      |
| STAT1                     | 0      |
| STAT2                     | 7      |
| STAT3                     | 8     |
| STAT4                     | 0     |
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      ...
      [0x80000000000740]:addi a1, zero, 217
      ...
      [0x80000000000af8]:lui s7, 128
      [0x80000000000afc]:csrrc zero, mstatus, s7
      [0x80000000000b00]:addi s1, zero, 4095
      [0x80000000000b04]:srli s1, s1, 62
      [0x80000000000b08]:slli s1, s1, 11
      [0x80000000000b0c]:csrrc zero, mstatus, s1
      [0x80000000000b10]:csrrs sp, mscratch, zero
      [0x80000000000b14]:ld t1, 1800(sp)
      [0x80000000000b18]:ld s1, 472(sp)
      [0x80000000000b1c]:sub t1, t1, s1
      [0x80000000000b20]:addi t1, t1, 16
      [0x80000000000b24]:auipc s1, 0
      [0x80000000000b28]:add s1, s1, t1
      [0x80000000000b2c]:csrrw s1, mepc, s1
      [0x80000000000b30]:mret
      [0x900000b34]:lui a4, 0
      [0x900000b38]:addi a4, a4, 0
      [0x900000b3c]:slli a4, a4, 11
      [0x900000b40]:addi a4, a4, 0
      [0x900000b44]:slli a4, a4, 11
      [0x900000b48]:addi a4, a4, 55
      [0x900000b4c]:slli a4, a4, 10
      [0x900000b50]:addi a4, a4, 685
      [0x900000b54]:sd a4, 16(s11)
      [0x900000b58]:addi zero, zero, 0
      [0x900000b5c]:lui t0, 0
      [0x900000b60]:addi t0, t0, 9
      [0x900000b64]:slli t0, t0, 11
      [0x900000b68]:addi t0, t0, 1024
      [0x900000b6c]:slli t0, t0, 11
      [0x900000b70]:addi t0, t0, 1
      [0x900000b74]:slli t0, t0, 10
      [0x900000b78]:addi t0, t0, 648
      [0x900000b7c]:ld sp, 0(t0)
 ...
 -- Signature Addresses:
      Address: 0x80000000007228 Data: 0x0000000000000538
 -- Redundant Coverpoints hit by the op
      - mnemonic : csrrs

...
| COV_LABELS                | reserved_rwx06      |
| TEST_NAME                 | /home/ammar/Documents/my-github/riscv-ctg/riscof_work/reserved_rwx/reserved_rwx06.S/ref.S    |
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      [0x80000000000ea4]:csrrs a0, mcause, zero
      [0x80000000000ea8]:addi s1, a0, 4088
      [0x80000000000eac]:andi s1, s1, 4092
      [0x80000000000eb0]:bne s1, zero, 12
      [0x80000000000ebc]:addi t2, zero, 32
      [0x80000000000ec0]:bge a0, zero, 68
      [0x80000000000f04]:csrrs t1, misa, zero
      [0x80000000000f08]:slli t1, t1, 56
      [0x80000000000f0c]:bge t1, zero, 8
      [0x80000000000f14]:ld t1, 536(sp)
      [0x80000000000f18]:add s1, t1, t2
      [0x80000000000f1c]:sd s1, 536(sp)
      [0x80000000000f20]:ld fp, 576(sp)
      [0x80000000000f24]:sub a1, a1, fp
      [0x80000000000f28]:slli a1, a1, 4
      [0x80000000000f2c]:or a1, a1, t2
      [0x80000000000f30]:addi a1, a1, 3
      [0x80000000000f34]:sd a1, 0(t1)
      [0x80000000000f38]:sd a0, 8(t1)
 -- Signature Addresses:
      Address: 0x80000000007220 Data: 0x000000000000000D
 -- Redundant Coverpoints hit by the op
      - mnemonic : csrrs
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      ...
      [0x800000000006c0]:addi a0, zero, 1
      [0x800000000006c4]:slli a0, a0, 55
      [0x800000000006c8]:addi a1, zero, 217
      [0x800000000006cc]:srli a0, a0, 12
      [0x800000000006d0]:slli a0, a0, 10
      [0x800000000006d4]:or a0, a0, a1
      [0x800000000006d8]:addi zero, zero, 0
      [0x800000000006dc]:addi zero, zero, 0
      [0x800000000006e0]:auipc t1, 6
      ...
      [0x80000000000720]:auipc a0, 0
      [0x80000000000724]:addi a0, a0, 3944
      ...
      [0x80000000000740]:addi a1, zero, 213
      ...
      [0x800000000009d0]:addi t0, t0, 1024
      [0x800000000009d4]:slli t0, t0, 11
      [0x800000000009d8]:addi t0, t0, 1
      [0x800000000009dc]:slli t0, t0, 10
      [0x800000000009e0]:addi t0, t0, 648
      [0x800000000009e4]:addi zero, zero, 0
      ...
      [0x80000000000a04]:addi t1, t1, 3208
      ...
      [0x80000000000a30]:sd t2, 1816(sp)
      [0x80000000000a34]:lui t0, 0
      [0x80000000000a38]:addi t0, t0, 10
      [0x80000000000a3c]:slli t0, t0, 11
      [0x80000000000a40]:addi t0, t0, 0
      [0x80000000000a44]:slli t0, t0, 11
      [0x80000000000a48]:addi t0, t0, 0
      [0x80000000000a4c]:slli t0, t0, 10
      [0x80000000000a50]:addi t0, t0, 280
      [0x80000000000a54]:addi zero, zero, 0
      [0x80000000000a58]:addi zero, zero, 0
      [0x80000000000a5c]:addi zero, zero, 0
      [0x80000000000a60]:auipc t1, 6
      ...
      [0x80000000000a90]:sd t2, 1832(sp)
      [0x80000000000a94]:lui t0, 0
      [0x80000000000a98]:addi t0, t0, 9
      [0x80000000000a9c]:slli t0, t0, 11
      [0x80000000000aa0]:addi t0, t0, 1024
      [0x80000000000aa4]:slli t0, t0, 11
      [0x80000000000aa8]:addi t0, t0, 1
      [0x80000000000aac]:slli t0, t0, 10
      [0x80000000000ab0]:addi t0, t0, 648
      ...
      [0x80000000000ae4]:ld t1, 520(sp)
      [0x80000000000ae8]:add t2, t1, t0
      [0x80000000000aec]:sd t2, 1184(sp)
      [0x80000000000af0]:sd t2, 1848(sp)
      [0x80000000000af4]:sfence.vma zero, zero
      [0x80000000000af8]:addi s1, zero, 4095
      [0x80000000000afc]:srli s1, s1, 62
      [0x80000000000b00]:slli s1, s1, 11
      [0x80000000000b04]:csrrc zero, mstatus, s1
      [0x80000000000b08]:csrrs sp, mscratch, zero
      [0x80000000000b0c]:ld t1, 1800(sp)
      [0x80000000000b10]:ld s1, 472(sp)
      [0x80000000000b14]:sub t1, t1, s1
      [0x80000000000b18]:addi t1, t1, 16
      [0x80000000000b1c]:auipc s1, 0
      [0x80000000000b20]:add s1, s1, t1
      [0x80000000000b24]:csrrw s1, mepc, s1
      [0x80000000000b28]:mret
      [0x900000b2c]:lui a4, 0
      [0x900000b30]:addi a4, a4, 0
      [0x900000b34]:slli a4, a4, 11
      [0x900000b38]:addi a4, a4, 0
      [0x900000b3c]:slli a4, a4, 11
      [0x900000b40]:addi a4, a4, 55
      [0x900000b44]:slli a4, a4, 10
      [0x900000b48]:addi a4, a4, 685
      [0x900000b4c]:sd a4, 16(s11)
      [0x900000b50]:addi zero, zero, 0
      [0x900000b54]:lui t0, 0
      [0x900000b58]:addi t0, t0, 9
      [0x900000b5c]:slli t0, t0, 11
      [0x900000b60]:addi t0, t0, 1024
      [0x900000b64]:slli t0, t0, 11
      [0x900000b68]:addi t0, t0, 1
      [0x900000b6c]:slli t0, t0, 10
      [0x900000b70]:addi t0, t0, 648
      [0x900000b74]:ld sp, 0(t0)
      [0x80000000000cc0]:jal zero, 256
      [0x80000000000dc0]:csrrw sp, mscratch, sp
      [0x80000000000dc4]:sd a1, 648(sp)
      [0x80000000000dc8]:jal a1, 184
      [0x80000000000e80]:sd a0, 640(sp)
      [0x80000000000e84]:csrrw a0, mscratch, sp
      [0x80000000000e88]:sd a0, 656(sp)
      [0x80000000000e8c]:ld a0, 560(sp)
      [0x80000000000e90]:jalr zero, a0, 0
      [0x80000000000e94]:sd s1, 632(sp)
      [0x80000000000e98]:sd fp, 624(sp)
      [0x80000000000e9c]:sd t2, 616(sp)
      [0x80000000000ea0]:sd t1, 608(sp)
      [0x80000000000ea4]:csrrs a0, mcause, zero
      [0x80000000000ea8]:addi s1, a0, 4088
      [0x80000000000eac]:andi s1, s1, 4092
      [0x80000000000eb0]:bne s1, zero, 12
      ...
      [0x80000000000f34]:sd a1, 0(t1)
      [0x80000000000f38]:sd a0, 8(t1)
      [0x80000000000f3c]:blt a0, zero, 324
      [0x80000000000f40]:addi s1, sp, 0
      [0x80000000000f44]:csrrs a1, mstatus, zero
      [0x80000000000f48]:slli fp, a1, 51
      [0x80000000000f4c]:blt fp, zero, 24
      [0x80000000000f50]:addi s1, s1, 664
      [0x80000000000f54]:srli a1, a1, 32
      [0x80000000000f58]:slli a1, a1, 24
      [0x80000000000f5c]:bge a1, zero, 8
      [0x80000000000f64]:csrrs t2, mepc, zero
      [0x80000000000f68]:ld fp, 520(s1)
      [0x80000000000f6c]:ld a1, 528(s1)
      [0x80000000000f70]:add a1, a1, fp
      [0x80000000000f74]:bgeu t2, a1, 8
      [0x80000000000f78]:bgeu t2, fp, 44
      [0x80000000000f7c]:ld fp, 472(s1)
      [0x80000000000f80]:ld a1, 480(s1)
      [0x80000000000f84]:add a1, a1, fp
      [0x80000000000f88]:bgeu t2, a1, 8
      [0x80000000000f8c]:bgeu t2, fp, 24
      [0x80000000000fa4]:sub fp, t2, fp
      [0x80000000000fa8]:sd fp, 16(t1)
 -- Signature Addresses:
      Address: 0x80000000007228 Data: 0x0000000000000530
 -- Redundant Coverpoints hit by the op
      - mnemonic : csrrs
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      ...
      [0x80000000000fa4]:sub fp, t2, fp
      [0x80000000000fa8]:sd fp, 16(t1)
      [0x80000000000fac]:andi a1, t2, 4092
      [0x80000000000fb0]:addi a1, a1, 8
      [0x80000000000fb4]:csrrw zero, mepc, a1
      [0x80000000000fb8]:csrrs t2, mtval, zero
      [0x80000000000fbc]:andi a0, a0, 15
      [0x80000000000fc0]:lui fp, 0
      [0x80000000000fc4]:addi fp, fp, 0
      [0x80000000000fc8]:slli fp, fp, 11
      [0x80000000000fcc]:addi fp, fp, 0
      [0x80000000000fd0]:slli fp, fp, 11
      [0x80000000000fd4]:addi fp, fp, 44
      [0x80000000000fd8]:slli fp, fp, 10
      [0x80000000000fdc]:addi fp, fp, 251
      [0x80000000000fe0]:srl fp, fp, a0
      [0x80000000000fe4]:slli fp, fp, 63
      [0x80000000000fe8]:bge fp, zero, 88
      [0x80000000000fec]:ld fp, 520(s1)
      [0x80000000000ff0]:ld a1, 528(s1)
      [0x80000000000ff4]:add a1, a1, fp
      [0x80000000000ff8]:bgeu t2, a1, 8
      [0x80000000000ffc]:bgeu t2, fp, 64
      [0x8000000000103c]:sub fp, t2, fp
      [0x80000000001040]:sd fp, 24(t1)
      [0x80000000001044]:ld s1, 536(sp)
      [0x80000000001048]:ld t2, 504(sp)
      [0x8000000000104c]:ld t1, 512(sp)
      [0x80000000001050]:add t1, t1, t2
      [0x80000000001054]:bltu t1, s1, 7028
      [0x80000000001058]:addi t2, zero, 512
      [0x8000000000105c]:jal zero, 64
      [0x8000000000109c]:auipc fp, 0
      [0x800000000010a0]:addi fp, fp, 60
      [0x800000000010a4]:add fp, fp, t2
      [0x800000000010a8]:slli t2, a0, 3
      [0x800000000010ac]:add fp, fp, t2
      [0x800000000010b0]:andi fp, fp, 4088
      [0x800000000010b4]:ld fp, 0(fp)
      [0x800000000010b8]:beq fp, zero, 7076
      [0x800000000010bc]:slli t2, fp, 63
      [0x800000000010c0]:bge t2, zero, 16
      [0x800000000010c4]:srli fp, fp, 1
      [0x800000000010c8]:beq a0, fp, 8088
      [0x80000000001060]:ld t1, 608(sp)
      [0x80000000001064]:ld t2, 616(sp)
      [0x80000000001068]:ld fp, 624(sp)
      [0x8000000000106c]:ld s1, 632(sp)
      [0x80000000001070]:ld a0, 640(sp)
      [0x80000000001074]:ld a1, 648(sp)
      [0x80000000001078]:ld sp, 656(sp)
      [0x8000000000107c]:mret
      [0x900000b7c]:sd sp, 0(t0)
      [0x80000000000cc0]:jal zero, 256
      [0x80000000000dc0]:csrrw sp, mscratch, sp
      [0x80000000000dc4]:sd a1, 648(sp)
      [0x80000000000dc8]:jal a1, 184
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      ...
      [0x80000000000f38]:sd a0, 8(t1)
 -- Signature Addresses:
      Address: 0x80000000007240 Data: 0x000000000000000F
 -- Redundant Coverpoints hit by the op
      - mnemonic : csrrs
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      [0x80000000000fa8]:sd fp, 16(t1)
 -- Signature Addresses:
      Address: 0x80000000007248 Data: 0x0000000000000538
 -- Redundant Coverpoints hit by the op
      - mnemonic : sd
...
[0x80000000000044]:addi s1, s1, 3200
...
[0x800000000001a4]:addi s1, s1, 992
...
[0x80000000001078]:ld sp, 656(sp)
[0x8000000000107c]:mret
[0x900000b84]:lui a4, 0
[0x900000b88]:addi a4, a4, 0
[0x900000b8c]:slli a4, a4, 11
[0x900000b90]:addi a4, a4, 0
[0x900000b94]:slli a4, a4, 11
[0x900000b98]:addi a4, a4, 47
[0x900000b9c]:slli a4, a4, 10
[0x900000ba0]:addi a4, a4, 751
[0x900000ba4]:sd a4, 24(s11)
[0x900000ba8]:addi zero, zero, 0
[0x900000bac]:addi sp, zero, 0
[0x900000bb0]:ecall
[0x80000000000cc0]:jal zero, 256
[0x80000000000dc0]:csrrw sp, mscratch, sp
[0x80000000000dc4]:sd a1, 648(sp)
...
[0x80000000000eac]:andi s1, s1, 4092
[0x80000000000eb0]:bne s1, zero, 12
[0x80000000000eb4]:ld t2, 656(sp)
[0x80000000000eb8]:beq t2, zero, 1652
[0x8000000000152c]:addi s1, a0, 4085
[0x80000000001530]:beq s1, zero, 32
[0x80000000001534]:csrrs t2, mstatus, zero
[0x80000000001538]:slli t2, t2, 24
[0x8000000000153c]:ld a1, 1136(sp)
[0x80000000001540]:bge t2, zero, 8
[0x80000000001548]:ld s1, 472(sp)
[0x8000000000154c]:sub s1, s1, a1
[0x80000000001550]:csrrs t2, mepc, zero
[0x80000000001554]:add t2, t2, s1
[0x80000000001558]:ld t1, 608(sp)
[0x8000000000155c]:ld fp, 624(sp)
[0x80000000001560]:ld s1, 632(sp)
[0x80000000001564]:ld a0, 640(sp)
[0x80000000001568]:ld a1, 648(sp)
[0x8000000000156c]:ld sp, 656(sp)
[0x80000000001570]:jalr zero, t2, 4
[0x80000000000bb4]:addi a3, a3, 8
[0x80000000000bb8]:addi a4, zero, 291
[0x80000000000bbc]:sd a4, 32(a3)
[0x80000000000bc0]:addi sp, zero, 0
[0x80000000000bc4]:ecall
[0x80000000000cc0]:jal zero, 256
[0x80000000000dc0]:csrrw sp, mscratch, sp
[0x80000000000dc4]:sd a1, 648(sp)
[0x80000000000dc8]:jal a1, 184
...
[0x8000000000156c]:ld sp, 656(sp)
[0x80000000001570]:jalr zero, t2, 4
[0x80000000000bc8]:csrrs t1, mscratch, zero
[0x80000000000bcc]:addi t1, t1, 664
[0x80000000000bd0]:ld t2, 568(t1)
[0x80000000000bd4]:ld t2, 544(t1)
[0x80000000000bd8]:csrrw zero, satp, t2
...
[0x80000000000bd4]:ld t2, 544(t1)
[0x80000000000bd8]:csrrw zero, satp, t2
[0x80000000000bdc]:ld a0, 592(t1)
[0x80000000000be0]:csrrw zero, sscratch, a0
[0x80000000000be4]:ld s1, 584(t1)
[0x80000000000be8]:csrrw t2, stvec, s1
[0x80000000000bec]:andi s1, s1, 4092
[0x80000000000bf0]:andi t2, t2, 4092
[0x80000000000bf4]:bne s1, t2, 32
[0x80000000000c14]:csrrs t1, mscratch, zero
[0x80000000000c18]:ld t2, 568(t1)
[0x80000000000c1c]:csrrw zero, medeleg, t2
[0x80000000000c20]:ld a0, 592(t1)
[0x80000000000c24]:csrrw zero, mscratch, a0
[0x80000000000c28]:ld s1, 584(t1)
[0x80000000000c2c]:csrrw t2, mtvec, s1
[0x80000000000c30]:andi s1, s1, 4092
[0x80000000000c34]:andi t2, t2, 4092
[0x80000000000c38]:bne s1, t2, 32
[0x80000000000c58]:jal zero, 4452
[0x80000000001dbc]:addi ra, zero, 1
[0x80000000001dc0]:auipc t5, 0
[0x80000000001dc4]:sw ra, 576(t5)
[0x80000000001dc8]:jal zero, 2097144
[0x80000000001dc0]:auipc t5, 0
[0x80000000001dc4]:sw ra, 576(t5)
[0x80000000001dc8]:jal zero, 2097144
[0x80000000001dc0]:auipc t5, 0

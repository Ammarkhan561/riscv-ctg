...
| COV_LABELS                | pmp_pte03      |
| TEST_NAME                 | /home/ammar/Documents/my-github/riscv-ctg/riscof_work/pmp_pte/pmp_pte03.S/ref.S    |
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      ...
      [0x8000000000088c]:addi a1, zero, 201
      ...
      [0x80000000000a54]:addi a1, zero, 199
      ...
      [0x80000000000b80]:addi t0, zero, 1672
      [0x80000000000b84]:addi zero, zero, 0
      ...
      [0x80000000000bd0]:lui t0, 0
      [0x80000000000bd4]:addi t0, t0, 9
      [0x80000000000bd8]:slli t0, t0, 11
      [0x80000000000bdc]:addi t0, t0, 1024
      [0x80000000000be0]:slli t0, t0, 11
      [0x80000000000be4]:addi t0, t0, 0
      [0x80000000000be8]:slli t0, t0, 10
      [0x80000000000bec]:addi t0, t0, 280
      ...
      [0x80000000000c30]:addi t0, zero, 1672
      ...
      [0x9c0000cb4]:lui a4, 0
      [0x9c0000cb8]:addi a4, a4, 0
      [0x9c0000cbc]:slli a4, a4, 11
      [0x9c0000cc0]:addi a4, a4, 0
      [0x9c0000cc4]:slli a4, a4, 11
      [0x9c0000cc8]:addi a4, a4, 55
      [0x9c0000ccc]:slli a4, a4, 10
      [0x9c0000cd0]:addi a4, a4, 685
      [0x9c0000cd4]:sd a4, 16(s11)
      [0x9c0000cd8]:addi zero, zero, 0
      [0x9c0000cdc]:addi t0, zero, 1672
      [0x9c0000ce0]:ld sp, 0(t0)
 ...
 -- Signature Addresses:
      Address: 0x80000000007228 Data: 0x000000000000069C
 -- Redundant Coverpoints hit by the op
      - mnemonic : csrrs
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      ...
      [0x80000000001194]:bltu t1, s1, 7072
      ...
      [0x800000000011f8]:beq fp, zero, 7120
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      [0x800000000010e8]:sd fp, 16(t1)
 -- Signature Addresses:
      Address: 0x80000000007248 Data: 0x00000000000006A4
 -- Redundant Coverpoints hit by the op
      - mnemonic : sd
...
[0x800000000011b8]:ld sp, 656(sp)
[0x800000000011bc]:mret
[0x9c0000cf0]:lui a4, 0
[0x9c0000cf4]:addi a4, a4, 0
[0x9c0000cf8]:slli a4, a4, 11
[0x9c0000cfc]:addi a4, a4, 0
[0x9c0000d00]:slli a4, a4, 11
[0x9c0000d04]:addi a4, a4, 47
[0x9c0000d08]:slli a4, a4, 10
[0x9c0000d0c]:addi a4, a4, 751
[0x9c0000d10]:sd a4, 24(s11)
[0x9c0000d14]:addi zero, zero, 0
[0x9c0000d18]:addi sp, zero, 0
[0x9c0000d1c]:ecall
[0x80000000000e00]:jal zero, 256
[0x80000000000f00]:csrrw sp, mscratch, sp
[0x80000000000f04]:sd a1, 648(sp)
...
[0x80000000000d20]:addi a3, a3, 8
[0x80000000000d24]:addi a4, zero, 291
[0x80000000000d28]:sd a4, 32(a3)
[0x80000000000d2c]:addi sp, zero, 0
[0x80000000000d30]:ecall
[0x80000000000e00]:jal zero, 256
[0x80000000000f00]:csrrw sp, mscratch, sp
[0x80000000000f04]:sd a1, 648(sp)
[0x80000000000f08]:jal a1, 184
...
[0x800000000016ac]:ld sp, 656(sp)
[0x800000000016b0]:jalr zero, t2, 4
[0x80000000000d34]:csrrs t1, mscratch, zero
[0x80000000000d38]:addi t1, t1, 664
[0x80000000000d3c]:ld t2, 568(t1)
[0x80000000000d40]:ld t2, 544(t1)
[0x80000000000d44]:csrrw zero, satp, t2
...
[0x80000000000d40]:ld t2, 544(t1)
[0x80000000000d44]:csrrw zero, satp, t2
[0x80000000000d48]:ld a0, 592(t1)
[0x80000000000d4c]:csrrw zero, sscratch, a0
[0x80000000000d50]:ld s1, 584(t1)
[0x80000000000d54]:csrrw t2, stvec, s1
[0x80000000000d58]:andi s1, s1, 4092
[0x80000000000d5c]:andi t2, t2, 4092
[0x80000000000d60]:bne s1, t2, 32
[0x80000000000d80]:csrrs t1, mscratch, zero
[0x80000000000d84]:ld t2, 568(t1)
[0x80000000000d88]:csrrw zero, medeleg, t2
[0x80000000000d8c]:ld a0, 592(t1)
[0x80000000000d90]:csrrw zero, mscratch, a0
[0x80000000000d94]:ld s1, 584(t1)
[0x80000000000d98]:csrrw t2, mtvec, s1
[0x80000000000d9c]:andi s1, s1, 4092
[0x80000000000da0]:andi t2, t2, 4092
[0x80000000000da4]:bne s1, t2, 32
[0x80000000000dc4]:jal zero, 4408

...
| COV_LABELS                | pmp_pte11      |
| TEST_NAME                 | /home/ammar/Documents/my-github/riscv-ctg/riscof_work/pmp_pte/pmp_pte11.S/ref.S    |
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      ...
      [0x800000000008b4]:addi a1, zero, 217
      ...
      [0x80000000000940]:addi a1, zero, 215
      ...
      [0x80000000000bb0]:sd t2, 1816(sp)
      [0x80000000000bb4]:lui t0, 0
      [0x80000000000bb8]:addi t0, t0, 9
      [0x80000000000bbc]:slli t0, t0, 11
      [0x80000000000bc0]:addi t0, t0, 88
      [0x80000000000bc4]:slli t0, t0, 11
      [0x80000000000bc8]:addi t0, t0, 0
      [0x80000000000bcc]:slli t0, t0, 10
      [0x80000000000bd0]:addi t0, t0, 280
      ...
      [0x80000000000c10]:sd t2, 1832(sp)
      ...
      [0x80000000000c28]:addi t0, t0, 1
      [0x80000000000c2c]:slli t0, t0, 10
      [0x80000000000c30]:addi t0, t0, 648
 ...
 -- Signature Addresses:
      Address: 0x80000000007228 Data: 0x0000000000000668
 -- Redundant Coverpoints hit by the op
      - mnemonic : csrrs
...
Op without unique coverpoint updates Signature
 ...
 -- Signature Addresses:
      Address: 0x80000000007230 Data: 0x0000000000000668
 -- Redundant Coverpoints hit by the op
      - mnemonic : sd
      - (rs1_val >= (pmpaddr2 << 2)) and ((pmpcfg0 & 0xFF0000) >> 16 == 0x18)
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      ...
      [0x800000000011d4]:bltu t1, s1, 7028
      ...
      [0x80000000001238]:beq fp, zero, 7076
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      [0x80000000001128]:sd fp, 16(t1)
 -- Signature Addresses:
      Address: 0x80000000007248 Data: 0x0000000000000670
 -- Redundant Coverpoints hit by the op
      - mnemonic : sd
      - (rs1_val >= (pmpaddr2 << 2)) and ((pmpcfg0 & 0xFF0000) >> 16 == 0x18)
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      [0x800000000011c0]:sd fp, 24(t1)
 -- Signature Addresses:
      Address: 0x80000000007250 Data: 0x0000000000000670
 -- Redundant Coverpoints hit by the op
      - mnemonic : sd
      - (rs1_val >= (pmpaddr2 << 2)) and ((pmpcfg0 & 0xFF0000) >> 16 == 0x18)
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      [0x80000000001128]:sd fp, 16(t1)
 -- Signature Addresses:
      Address: 0x80000000007268 Data: 0x0000000000000678
 -- Redundant Coverpoints hit by the op
      - mnemonic : sd
      - (rs1_val >= (pmpaddr2 << 2)) and ((pmpcfg0 & 0xFF0000) >> 16 == 0x18)
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      [0x800000000011c0]:sd fp, 24(t1)
 -- Signature Addresses:
      Address: 0x80000000007270 Data: 0x0000000000000678
 -- Redundant Coverpoints hit by the op
      - mnemonic : sd
      - (rs1_val >= (pmpaddr2 << 2)) and ((pmpcfg0 & 0xFF0000) >> 16 == 0x18)
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      [0x80000000001128]:sd fp, 16(t1)
 -- Signature Addresses:
      Address: 0x80000000007288 Data: 0x0000000000000680
 -- Redundant Coverpoints hit by the op
      - mnemonic : sd
      - (rs1_val >= (pmpaddr2 << 2)) and ((pmpcfg0 & 0xFF0000) >> 16 == 0x18)
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      [0x800000000011c0]:sd fp, 24(t1)
 -- Signature Addresses:
      Address: 0x80000000007290 Data: 0x0000000000000680
 -- Redundant Coverpoints hit by the op
      - mnemonic : sd
      - (rs1_val >= (pmpaddr2 << 2)) and ((pmpcfg0 & 0xFF0000) >> 16 == 0x18)
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      [0x80000000001128]:sd fp, 16(t1)
 -- Signature Addresses:
      Address: 0x800000000072a8 Data: 0x0000000000000688
 -- Redundant Coverpoints hit by the op
      - mnemonic : sd
      - (rs1_val >= (pmpaddr2 << 2)) and ((pmpcfg0 & 0xFF0000) >> 16 == 0x18)
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      [0x800000000011c0]:sd fp, 24(t1)
 -- Signature Addresses:
      Address: 0x800000000072b0 Data: 0x0000000000000688
 -- Redundant Coverpoints hit by the op
      - mnemonic : sd
      - (rs1_val >= (pmpaddr2 << 2)) and ((pmpcfg0 & 0xFF0000) >> 16 == 0x18)
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      [0x80000000001128]:sd fp, 16(t1)
 -- Signature Addresses:
      Address: 0x800000000072c8 Data: 0x0000000000000690
 -- Redundant Coverpoints hit by the op
      - mnemonic : sd
      - (rs1_val >= (pmpaddr2 << 2)) and ((pmpcfg0 & 0xFF0000) >> 16 == 0x18)
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      [0x800000000011c0]:sd fp, 24(t1)
 -- Signature Addresses:
      Address: 0x800000000072d0 Data: 0x0000000000000690
 -- Redundant Coverpoints hit by the op
      - mnemonic : sd
      - (rs1_val >= (pmpaddr2 << 2)) and ((pmpcfg0 & 0xFF0000) >> 16 == 0x18)
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      [0x80000000001128]:sd fp, 16(t1)
 -- Signature Addresses:
      Address: 0x800000000072e8 Data: 0x0000000000000698
 -- Redundant Coverpoints hit by the op
      - mnemonic : sd
      - (rs1_val >= (pmpaddr2 << 2)) and ((pmpcfg0 & 0xFF0000) >> 16 == 0x18)
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      [0x800000000011c0]:sd fp, 24(t1)
 -- Signature Addresses:
      Address: 0x800000000072f0 Data: 0x0000000000000698
 -- Redundant Coverpoints hit by the op
      - mnemonic : sd
      - (rs1_val >= (pmpaddr2 << 2)) and ((pmpcfg0 & 0xFF0000) >> 16 == 0x18)
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      [0x80000000001128]:sd fp, 16(t1)
 -- Signature Addresses:
      Address: 0x80000000007308 Data: 0x00000000000006A0
 -- Redundant Coverpoints hit by the op
      - mnemonic : sd
      - (rs1_val >= (pmpaddr2 << 2)) and ((pmpcfg0 & 0xFF0000) >> 16 == 0x18)
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      [0x800000000011c0]:sd fp, 24(t1)
 -- Signature Addresses:
      Address: 0x80000000007310 Data: 0x00000000000006A0
 -- Redundant Coverpoints hit by the op
      - mnemonic : sd
      - (rs1_val >= (pmpaddr2 << 2)) and ((pmpcfg0 & 0xFF0000) >> 16 == 0x18)
...
[0x800000000011d0]:add t1, t1, t2
[0x800000000011d4]:bltu t1, s1, 7028
[0x80000000000d48]:csrrs t1, mscratch, zero
[0x80000000000d4c]:addi t1, t1, 664
[0x80000000000d50]:ld t2, 568(t1)
[0x80000000000d54]:ld t2, 544(t1)
[0x80000000000d58]:csrrw zero, satp, t2
...
[0x80000000000d54]:ld t2, 544(t1)
[0x80000000000d58]:csrrw zero, satp, t2
[0x80000000000d5c]:ld a0, 592(t1)
[0x80000000000d60]:csrrw zero, sscratch, a0
[0x80000000000d64]:ld s1, 584(t1)
[0x80000000000d68]:csrrw t2, stvec, s1
[0x80000000000d6c]:andi s1, s1, 4092
[0x80000000000d70]:andi t2, t2, 4092
[0x80000000000d74]:bne s1, t2, 32
[0x80000000000d94]:csrrs t1, mscratch, zero
[0x80000000000d98]:ld t2, 568(t1)
[0x80000000000d9c]:csrrw zero, medeleg, t2
[0x80000000000da0]:ld a0, 592(t1)
[0x80000000000da4]:csrrw zero, mscratch, a0
[0x80000000000da8]:ld s1, 584(t1)
[0x80000000000dac]:csrrw t2, mtvec, s1
[0x80000000000db0]:andi s1, s1, 4092
[0x80000000000db4]:andi t2, t2, 4092
[0x80000000000db8]:bne s1, t2, 32
[0x80000000000dd8]:jal zero, 4452

...
| COV_LABELS                | pmp_pte01      |
| TEST_NAME                 | /home/ammar/Documents/my-github/riscv-ctg/riscof_work/pmp_pte/pmp_pte01.S/ref.S    |
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      ...
      [0x80000000000704]:addi t1, t1, 1556
      ...
      [0x80000000000994]:addi a1, zero, 201
      ...
      [0x80000000000a20]:addi a1, zero, 199
      ...
      [0x80000000000ba4]:lui t0, 0
      [0x80000000000ba8]:addi t0, t0, 9
      [0x80000000000bac]:slli t0, t0, 11
      [0x80000000000bb0]:addi t0, t0, 0
      [0x80000000000bb4]:slli t0, t0, 11
      [0x80000000000bb8]:addi t0, t0, 1
      [0x80000000000bbc]:slli t0, t0, 10
      [0x80000000000bc0]:addi t0, t0, 648
      [0x80000000000bc4]:addi zero, zero, 0
      ...
      [0x80000000000c24]:addi t0, t0, 44
      [0x80000000000c28]:slli t0, t0, 10
      [0x80000000000c2c]:addi t0, t0, 280
      ...
      [0x80000000000c70]:lui t0, 0
      [0x80000000000c74]:addi t0, t0, 9
      [0x80000000000c78]:slli t0, t0, 11
      [0x80000000000c7c]:addi t0, t0, 0
      [0x80000000000c80]:slli t0, t0, 11
      [0x80000000000c84]:addi t0, t0, 1
      [0x80000000000c88]:slli t0, t0, 10
      [0x80000000000c8c]:addi t0, t0, 648
      ...
      [0x80000000000cd0]:sfence.vma zero, zero
      [0x80000000000cd4]:addi s1, zero, 4095
      [0x80000000000cd8]:srli s1, s1, 62
      [0x80000000000cdc]:slli s1, s1, 11
      [0x80000000000ce0]:csrrc zero, mstatus, s1
      [0x80000000000ce4]:addi s1, zero, 1
      [0x80000000000ce8]:slli s1, s1, 11
      [0x80000000000cec]:csrrs zero, mstatus, s1
      [0x80000000000cf0]:csrrs sp, mscratch, zero
      [0x80000000000cf4]:ld t1, 1136(sp)
      [0x80000000000cf8]:ld s1, 472(sp)
      [0x80000000000cfc]:sub t1, t1, s1
      [0x80000000000d00]:addi t1, t1, 16
      [0x80000000000d04]:auipc s1, 0
      [0x80000000000d08]:add s1, s1, t1
      [0x80000000000d0c]:csrrw s1, mepc, s1
      [0x80000000000d10]:mret
      [0x90000ad14]:lui a4, 0
      [0x90000ad18]:addi a4, a4, 0
      [0x90000ad1c]:slli a4, a4, 11
      [0x90000ad20]:addi a4, a4, 0
      [0x90000ad24]:slli a4, a4, 11
      [0x90000ad28]:addi a4, a4, 55
      [0x90000ad2c]:slli a4, a4, 10
      [0x90000ad30]:addi a4, a4, 685
      [0x90000ad34]:sd a4, 16(s11)
      [0x90000ad38]:addi zero, zero, 0
      [0x90000ad3c]:lui t0, 0
      [0x90000ad40]:addi t0, t0, 9
      [0x90000ad44]:slli t0, t0, 11
      [0x90000ad48]:addi t0, t0, 0
      [0x90000ad4c]:slli t0, t0, 11
      [0x90000ad50]:addi t0, t0, 1
      [0x90000ad54]:slli t0, t0, 10
      [0x90000ad58]:addi t0, t0, 648
      [0x90000ad5c]:ld sp, 0(t0)
 ...
 -- Signature Addresses:
      Address: 0x80000000007228 Data: 0x0000000000000718
 -- Redundant Coverpoints hit by the op
      - mnemonic : csrrs
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      ...
      [0x80000000001214]:bltu t1, s1, 7068
      ...
      [0x80000000001278]:beq fp, zero, 7116
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      [0x80000000001168]:sd fp, 16(t1)
 -- Signature Addresses:
      Address: 0x80000000007248 Data: 0x0000000000000720
 -- Redundant Coverpoints hit by the op
      - mnemonic : sd
...
[0x80000000001238]:ld sp, 656(sp)
[0x8000000000123c]:mret
[0x90000ad6c]:lui a4, 0
[0x90000ad70]:addi a4, a4, 0
[0x90000ad74]:slli a4, a4, 11
[0x90000ad78]:addi a4, a4, 0
[0x90000ad7c]:slli a4, a4, 11
[0x90000ad80]:addi a4, a4, 47
[0x90000ad84]:slli a4, a4, 10
[0x90000ad88]:addi a4, a4, 751
[0x90000ad8c]:sd a4, 24(s11)
[0x90000ad90]:addi zero, zero, 0
[0x90000ad94]:addi sp, zero, 0
[0x90000ad98]:ecall
[0x80000000000e80]:jal zero, 256
[0x80000000000f80]:csrrw sp, mscratch, sp
[0x80000000000f84]:sd a1, 648(sp)
...
[0x80000000000d9c]:addi a3, a3, 8
[0x80000000000da0]:addi a4, zero, 291
[0x80000000000da4]:sd a4, 32(a3)
[0x80000000000da8]:addi sp, zero, 0
[0x80000000000dac]:ecall
[0x80000000000e80]:jal zero, 256
[0x80000000000f80]:csrrw sp, mscratch, sp
[0x80000000000f84]:sd a1, 648(sp)
[0x80000000000f88]:jal a1, 184
...
[0x8000000000172c]:ld sp, 656(sp)
[0x80000000001730]:jalr zero, t2, 4
[0x80000000000db0]:csrrs t1, mscratch, zero
[0x80000000000db4]:addi t1, t1, 664
[0x80000000000db8]:ld t2, 568(t1)
[0x80000000000dbc]:ld t2, 544(t1)
[0x80000000000dc0]:csrrw zero, satp, t2
...
[0x80000000000dbc]:ld t2, 544(t1)
[0x80000000000dc0]:csrrw zero, satp, t2
[0x80000000000dc4]:ld a0, 592(t1)
[0x80000000000dc8]:csrrw zero, sscratch, a0
[0x80000000000dcc]:ld s1, 584(t1)
[0x80000000000dd0]:csrrw t2, stvec, s1
[0x80000000000dd4]:andi s1, s1, 4092
[0x80000000000dd8]:andi t2, t2, 4092
[0x80000000000ddc]:bne s1, t2, 32
[0x80000000000dfc]:csrrs t1, mscratch, zero
[0x80000000000e00]:ld t2, 568(t1)
[0x80000000000e04]:csrrw zero, medeleg, t2
[0x80000000000e08]:ld a0, 592(t1)
[0x80000000000e0c]:csrrw zero, mscratch, a0
[0x80000000000e10]:ld s1, 584(t1)
[0x80000000000e14]:csrrw t2, mtvec, s1
[0x80000000000e18]:andi s1, s1, 4092
[0x80000000000e1c]:andi t2, t2, 4092
[0x80000000000e20]:bne s1, t2, 32
[0x80000000000e40]:jal zero, 4412

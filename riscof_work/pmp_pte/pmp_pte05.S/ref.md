...
| COV_LABELS                | pmp_pte05      |
| TEST_NAME                 | /home/ammar/Documents/my-github/riscv-ctg/riscof_work/pmp_pte/pmp_pte05.S/ref.S    |
...
Op without unique coverpoint updates Signature
 -- Code Sequence:
      ...
      [0x80000000000914]:addi a1, zero, 217
      ...
      [0x800000000009a0]:addi a1, zero, 215
      ...
      [0x80000000000ba0]:sd t2, 1800(sp)
      ...
      [0x80000000000c20]:addi t0, t0, 88
      [0x80000000000c24]:slli t0, t0, 11
      [0x80000000000c28]:addi t0, t0, 0
      ...
      [0x90a000d0c]:lui a4, 0
      [0x90a000d10]:addi a4, a4, 0
      [0x90a000d14]:slli a4, a4, 11
      [0x90a000d18]:addi a4, a4, 0
      [0x90a000d1c]:slli a4, a4, 11
      [0x90a000d20]:addi a4, a4, 55
      [0x90a000d24]:slli a4, a4, 10
      [0x90a000d28]:addi a4, a4, 685
      [0x90a000d2c]:sd a4, 16(s11)
      [0x90a000d30]:addi zero, zero, 0
      [0x90a000d34]:lui t0, 0
      [0x90a000d38]:addi t0, t0, 9
      [0x90a000d3c]:slli t0, t0, 11
      [0x90a000d40]:addi t0, t0, 0
      [0x90a000d44]:slli t0, t0, 11
      [0x90a000d48]:addi t0, t0, 1
      [0x90a000d4c]:slli t0, t0, 10
      [0x90a000d50]:addi t0, t0, 648
      [0x90a000d54]:ld sp, 0(t0)
...
[0x80000000001238]:ld sp, 656(sp)
[0x8000000000123c]:mret
[0x90a000d64]:lui a4, 0
[0x90a000d68]:addi a4, a4, 0
[0x90a000d6c]:slli a4, a4, 11
[0x90a000d70]:addi a4, a4, 0
[0x90a000d74]:slli a4, a4, 11
[0x90a000d78]:addi a4, a4, 47
[0x90a000d7c]:slli a4, a4, 10
[0x90a000d80]:addi a4, a4, 751
[0x90a000d84]:sd a4, 24(s11)
[0x90a000d88]:addi zero, zero, 0
[0x90a000d8c]:addi sp, zero, 0
[0x90a000d90]:ecall
[0x80000000000e80]:jal zero, 256
[0x80000000000f80]:csrrw sp, mscratch, sp
[0x80000000000f84]:sd a1, 648(sp)
